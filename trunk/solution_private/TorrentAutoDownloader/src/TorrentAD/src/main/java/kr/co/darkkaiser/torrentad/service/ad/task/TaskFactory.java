...
public final class TaskFactory {
	...
	public static Task createTask(TaskType type, String taskId, String taskDescription, TaskMetadataRegistry taskMetadataRegistry) {
		if (type == TaskType.ONCE_SCHEDULED) {
			return new OnceScheduledTaskImpl(taskId, taskDescription, taskMetadataRegistry);
		} else if (type == TaskType.PERIODIC_SCHEDULED) {
			return new PeriodicScheduledTaskImpl(taskId, taskDescription, taskMetadataRegistry);
