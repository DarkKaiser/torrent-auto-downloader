...
CREATE INDEX TBL_VOCABULARY_INDEX02
          ON TBL_VOCABULARY(WORD_CLASS);

CREATE INDEX TBL_VOCABULARY_INDEX03
          ON TBL_VOCABULARY(JLPT_CLASS);
