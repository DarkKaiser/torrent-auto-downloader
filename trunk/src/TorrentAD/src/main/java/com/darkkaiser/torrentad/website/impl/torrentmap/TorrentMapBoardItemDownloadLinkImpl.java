...
public final class TorrentMapBoardItemDownloadLinkImpl implements TorrentMapBoardItemDownloadLink {
	...
	public static TorrentMapBoardItemDownloadLink newInstance(final String id, final String value1, final String value2, final String value3, final String value4, final String fileId, final String fileName) {
		return new TorrentMapBoardItemDownloadLinkImpl(id, value1, value2, value3, value4, fileId, fileName);
	}

	private TorrentMapBoardItemDownloadLinkImpl(final String id, final String value1, final String value2, final String value3, final String value4, final String fileId, final String fileName) {
